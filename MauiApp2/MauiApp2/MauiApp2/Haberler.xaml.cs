...
public partial class Haberler : ContentPage
{
            ...
            if (root != null)
            {
                ...
                foreach (var news in root.items)
                {
                    FilteredNewsItems.Add(new HaberlerItem
                    {
                        ...
                        Author = news.author,
                        Link = news.link // Haber detayýna gitmek için linki ekledik
                    });
                }
            }
            else
    ...
    private void CategoryButton_Clicked(object sender, EventArgs e)
    {
        ...
        {
            // Önceki seçili butonun rengini varsayýlan hale getir
            if (_selectedButton != null)
            {
                _selectedButton.BackgroundColor = Colors.Gray;
                _selectedButton.TextColor = Colors.White;
            }

            // Yeni seçili butonun rengini deðiþtir
